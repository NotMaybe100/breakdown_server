...
#ifndef BREAKDOWN_SERVER_SWIFT_H
#define BREAKDOWN_SERVER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="breakdown_server",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16breakdown_server11AppDelegate")
...
SWIFT_CLASS("_TtC16breakdown_server17MainFlutterWindow")
